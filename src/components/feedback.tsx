...
export const Feedback = () => {
    const titleClass = "ml-[36px] rounded-tl-[48px] rounded-tr-[48px] px-[48px] py-[16px] uppercase text-white text-[20px] font-bold bg-[#A9BDA1] w-[300px]";
    ...
    return (
        <section className="w-full flex flex-col items-center bg-[#F5F6FA]
        p-10
        xl:px-32
        2xl:px-40
        ">
